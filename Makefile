CXX      := g++
CXXFLAGS := -I/usr/local/include/ -fopenmp -pthread -fno-strict-aliasing -std=c++0x -pedantic -Wall
LDFLAGS  := -fopenmp -L/opt/local/lib
LIBS     := -lm -L/usr/local/lib -lopencv_features2d -lopencv_flann -lopencv_objdetect -lopencv_highgui -lopencv_ml -lopencv_photo -lopencv_shape -lopencv_superres -lopencv_video -lopencv_videoio -lopencv_imgcodecs -lopencv_imgproc -lopencv_core -ldlib -lgif
